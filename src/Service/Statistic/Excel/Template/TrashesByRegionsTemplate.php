...
class TrashesByRegionsTemplate extends AbstractTemplate
{
	...
	public function setSpreadsheetDescription(Spreadsheet $spreadsheet): void
	{
		$spreadsheet->getProperties()
			...
			->setTitle("Produkce zdravotnického odpadu v roce ".$this->year)
			->setSubject("Produkce zdravotnického odpadu v roce ".$this->year)
			->setDescription(
				"Data o produkci zdravotnického odpadu v roce ".$this->year
			)
